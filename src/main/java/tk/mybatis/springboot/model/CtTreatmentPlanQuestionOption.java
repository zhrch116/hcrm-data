...
@Table(name = "CT_TREATMENT_PLAN_QUESTION_OPTION")
public class CtTreatmentPlanQuestionOption {
    @Id
    @Column(name = "QUESTION_OPTION_KEY_ID")
    private Integer questionOptionKeyId;
    ...
    /**
     * @return QUESTION_OPTION_KEY_ID
     */
    public Integer getQuestionOptionKeyId() {
        return questionOptionKeyId;
    }

    /**
     * @param questionOptionKeyId
     */
    public void setQuestionOptionKeyId(Integer questionOptionKeyId) {
        this.questionOptionKeyId = questionOptionKeyId;
    }
