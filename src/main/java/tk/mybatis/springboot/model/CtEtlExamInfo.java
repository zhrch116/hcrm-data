...
@Table(name = "CT_ETL_EXAM_INFO")
public class CtEtlExamInfo {
    @Id
    @Column(name = "EXAM_KEY_ID")
    private Integer examKeyId;

    @Column(name = "HOS_EXAM_KEY_ID")
    private Integer hosExamKeyId;
    ...
    /**
     * @return HOS_EXAM_KEY_ID
     */
    public Integer getHosExamKeyId() {
        return hosExamKeyId;
    }
     ...
     * @param hosExamKeyId
     */
    public void setHosExamKeyId(Integer hosExamKeyId) {
        this.hosExamKeyId = hosExamKeyId;
    }
