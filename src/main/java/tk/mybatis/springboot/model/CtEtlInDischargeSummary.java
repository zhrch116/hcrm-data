...
@Table(name = "CT_ETL_IN_DISCHARGE_SUMMARY")
public class CtEtlInDischargeSummary {
    @Id
    @Column(name = "DISCHARGE_SUMMARY_KEY_ID")
    private Integer dischargeSummaryKeyId;

    @Column(name = "HOS_DISCHARGE_SUMMARY_KEY_ID")
    private Integer hosDischargeSummaryKeyId;
    ...
    /**
     * @return HOS_DISCHARGE_SUMMARY_KEY_ID
     */
    public Integer getHosDischargeSummaryKeyId() {
        return hosDischargeSummaryKeyId;
    }

    /**
     * @param hosDischargeSummaryKeyId
     */
    public void setHosDischargeSummaryKeyId(Integer hosDischargeSummaryKeyId) {
        this.hosDischargeSummaryKeyId = hosDischargeSummaryKeyId;
    }
