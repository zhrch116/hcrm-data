...
@Table(name = "CT_ETL_LAB_DETAIL_INFO")
public class CtEtlLabDetailInfo {
    @Id
    @Column(name = "LAB_DETAIL_KEY_ID")
    private Integer labDetailKeyId;

    @Column(name = "HOS_LAB_DETAIL_KEY_ID")
    private Integer hosLabDetailKeyId;
    ...
    /**
     * @return HOS_LAB_DETAIL_KEY_ID
     */
    public Integer getHosLabDetailKeyId() {
        return hosLabDetailKeyId;
    }

    /**
     * @param hosLabDetailKeyId
     */
    public void setHosLabDetailKeyId(Integer hosLabDetailKeyId) {
        this.hosLabDetailKeyId = hosLabDetailKeyId;
    }
