...
@Table(name = "CT_ETL_OPERATION_DETAIL_INFO")
public class CtEtlOperationDetailInfo {
    @Id
    @Column(name = "OPERATION_DETAIL_KEY_ID")
    private Integer operationDetailKeyId;

    @Column(name = "HOS_OPERATION_DETAIL_KEY_ID")
    private Integer hosOperationDetailKeyId;
    ...
    /**
     * @return HOS_OPERATION_DETAIL_KEY_ID
     */
    public Integer getHosOperationDetailKeyId() {
        return hosOperationDetailKeyId;
    }

    /**
     * @param hosOperationDetailKeyId
     */
    public void setHosOperationDetailKeyId(Integer hosOperationDetailKeyId) {
        this.hosOperationDetailKeyId = hosOperationDetailKeyId;
    }
